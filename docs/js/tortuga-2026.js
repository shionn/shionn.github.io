...
q(function() {
	...
	let q1 = new _quest("quest-1", "Décoder le Parchemin de Barbe Drue", "Peindre 40 figurines", 40)
			...
			.progress("03/01/2026", whisp, 1, "Sorcier HQ", _SMALL)
			.doChallenge("03/01/2026", whisp)
			.progress("03/01/2026", tony, 1, "Beast", _SMALL)
			.progress("03/01/2026", shionn, 4, "Leader Chaos D&L", _SMALL)
			.progress("07/01/2026", bnachee, 1, "Gunpla", _MEDIUM)
			.progress("08/01/2026", whisp, 1, "homme des neiges", _MEDIUM)
			.progress("12/01/2026", shionn, 3, "Fanatique Gobelin", _SMALL)
			.progress("12/01/2026", shionn, 1, "Shaman Gobelin", _SMALL)
			.doLangCorrection("13/01/2026", faran, 5)
			.progress("15/01/2026", whisp, 1, "Tu'ur", _MEDIUM)
			.progress("16/01/2026", tupad, 4, "Bariccade", _MEDIUM_DECOR)
	...
	let q3 = new _quest("quest-3", "Rassembler un équipage", "Peindre 40 figurines", 40)
			...
			.progress("28/02/2026", jeff, 2, "Orc", _SMALL)
	...
	let q4 = new _quest("quest-4", "Rassembler un équipage (shionn proctrastine)", "Peindre 40 figurines", 40)
			...
			.progress("30/03/2026", tony, 1, "Buste animé", _SMALL)
			.progress("30/03/2026", shionn, 1, "Roi Nain", _SMALL)
			.progress("30/03/2026", shionn, 1, "Driade", _MEDIUM)
			.render();
