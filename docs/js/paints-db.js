...
let createPaint = function(brand, id, name) {
	const p = { id : id, name : name, brand : brand };
	paints.set(id, p);
	return p;
}
...
createPaint(AP, "WP1107", "Demonic Yelow");
...
equivalence(DAKKA, [ 72008, "22-02", "old-gw-fiery-orange", "WP1211"]);
equivalence(DAKKA, [ 72009, "72024", "old-gw-blazing-orange", "WP1442"]);
...
equivalence(DAKKA, [ 72022, "70829", "old-gw-ultramarine-blue", "WP1115"]);
equivalence(DAKKA, [ 72143, "21-08", "old-gw-mordian-blue", "WP1415"]);
equivalence(DAKKA, [ 72021, "21-09", "old-gw-enchanted-blue", "WP1114"]);
equivalence(DAKKA, [ 72095, "72114", "old-gw-ice-blue", "WP1452"]);
equivalence(DAKKA, [ 72023, "72401", "old-gw-lightning-bolt-blue", "WP1113"]);
...
equivalence(DAKKA, [ "old-gw-adeptus-battlegrey"]);
...
equivalence(DAKKA, [ 72056, "21-01", "old-gw-burnished-gold", "WP1231"]);
equivalence(DAKKA, [ 72055, "22-61", "old-gw-shining-gold", "WP1132"]);
equivalence(DAKKA, [ 72057, "72143", "old-gw-dwarf-bronze", "WP1133"]);
...
equivalence(DAKKA, [ "old-gw-flesh-wash"]);
equivalence(DAKKA, [ "old-gw-magenta-ink"]);
...
equivalence(DAKKA, [ 72207, "24-05", "old-gw-asurmen-blue-wash", "WP1139"]);
equivalence(DAKKA, [ 72206, "24-03", "old-gw-baal-red-wash", "WP1138"]);
equivalence(DAKKA, [ 72201, "24-12", "old-gw-badab-black-wash", "WP1136"]);
equivalence(DAKKA, [ 72203, "24-11", "old-gw-devlan-mud-wash", "WP1135"]);
equivalence(DAKKA, [ 72200, "24-09", "old-gw-gryphonne-sepia-wash", "WP1134"]);
equivalence(DAKKA, [ 72202, "24-04", "old-gw-leviathan-purple-wash", "WP1140"]);
equivalence(DAKKA, [ 72204, "24-10", "old-gw-ogryn-flesh-wash", "WP1143"]);
